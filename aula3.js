...
console.log(receita[0].valor)

console.log("exercicio 1")
let soma =0

for(let valores of receita) {
    soma = soma + valores.valor
}
...
for(let gorjetas of receita){
    soma = soma + gorjetas.gorjeta
}
...
for(let contas of receita){
    if (contas.valor <= 50) {contagem = contagem +1}
}
